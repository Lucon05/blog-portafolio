  ...
  return (
    <div className="    w-1/1 flex flex-col items-center bg-[#722F37] text-[#f5f5dc]">
      ...
      <div className="m-5 flex flex-row space-x-10">
        <a href="https://www.linkedin.com/in/luis-alfonso-contreras-marquez-487014362/?trk=opento_sprofile_topcard">
          <svg
            className="h-10 w-10"
            viewBox="0 0 24 24"
          ...
          >
            <path
              className="fill-[#f5f5dc] hover:fill-blue-400"
              d="M20.47,2H3.53A1.45,1.45,0,0,0,2.06,3.43V20.57A1.45,1.45,0,0,0,3.53,22H20.47a1.45,1.45,0,0,0,1.47-1.43V3.43A1.45,1.45,0,0,0,20.47,2ZM8.09,18.74h-3v-9h3ZM6.59,8.48h0a1.56,1.56,0,1,1,0-3.12,1.57,1.57,0,1,1,0,3.12ZM18.91,18.74h-3V13.91c0-1.21-.43-2-1.52-2A1.65,1.65,0,0,0,12.85,13a2,2,0,0,0-.1.73v5h-3s0-8.18,0-9h3V11A3,3,0,0,1,15.46,9.5c2,0,3.45,1.29,3.45,4.06Z"
            />
          </svg>
        </a>

        <a href="https://github.com/Lucon05?tab=overview&from=2026-02-01&to=2026-02-13">
          <svg
            className="h-10 w-10"
            viewBox="0 0 24 24"
            xmlns="http://www.w3.org/2000/svg"
          >
            <path
              className="fill-[#f5f5dc] hover:fill-gray-900"
        ...
        <a href="tel:+491638520989">
          ...
          >
            <path
              className="fill-[#f5f5dc] hover:fill-[#5DD3B6]"
        ...
        <a href="mailto:contrerasluis1105@gmail.com">
          ...
          >
            <path
              ...
              className="fill-[#f5f5dc] hover:fill-[#FFCE1B]"
            />
          </svg>
        </a>
      </div>

  ...
  return (
    ...
    <div className={className}>
      ...
      <div className="m-5 flex flex-row space-x-10">
        {/* LinkedIn */}
        <a
          href="https://www.linkedin.com/in/luis-alfonso-contreras-marquez-487014362/"
          target="_blank"
        ...
        >
          ...
          >
            <path
              className="fill-[#f5f5dc] transition-colors hover:fill-blue-400"
        ...
        >
          ...
          >
            <path
              className="fill-[#f5f5dc] transition-colors hover:fill-gray-900"
        ...
        <a href="tel:+491638520989">
          ...
          >
            <path
              className="fill-[#f5f5dc] transition-colors hover:fill-[#5DD3B6]"
        ...
        <a href="mailto:contrerasluis1105@gmail.com">
          ...
          >
            <path
              className="fill-[#f5f5dc] transition-colors hover:fill-[#FFCE1B]"
